                ...
                <div class="portlet-body">
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                        ...
                        <tr>
                            ...
                            <th>  المدينة بالانجليزي </th>
                            <th>  المدينة بالهندي </th>
                        ...
                        @foreach($cities as $city)
                            @if($city->parent_id == null)
                                <tr class="odd gradeX">
                                    ...
                                    <td> {{$city->hi_name}} </td>
                                    @php 
                                      $orders = App\Order::where('city_id',$city->id)->where('state','completed')->count();
                                    @endphp
                                    <td> {{$orders}} </td>
                                    ...
                                    <td>
                                        ...
                                        <li>
                                            <a class="delete_country" data="{{$city->id}}" data_name="{{$city->ar_name}}" >
