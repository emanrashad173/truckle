...
@section('page_header')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span>أضافة أنترو التطبيق</span>
            </li>
        </ul>
    </div>

    <h1 class="page-title">  أنترو التطبيق
        <small>أضافة أنترو التطبيق  </small>
    </h1>
@endsection
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="portlet light ">
                            ...
                            <form role="form" action="{{route('storeSplash')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane active" id="tab_1_1">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="title" placeholder="أكتب عنوان الأنترو" class="form-control" value="{{old('title')}}" />
                                                @if ($errors->has('title'))
