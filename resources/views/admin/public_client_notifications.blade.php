...
@section('page_header')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{url('/admin/public_client_notifications')}}">ألاشعارات العامة للعملاء</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                <span>عرض ألاشعارات العامة للعملاء</span>
            </li>
        </ul>
    </div>

    <h1 class="page-title">عرض ألاشعارات العامة للعملاء
        <small>اضافة جميع ألاشعارات العامة للعملاء</small>
    </h1>
...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <!-- BEGIN TAB PORTLET-->
            <form method="post" action="{{route('storePublicClientNotification')}}" enctype="multipart/form-data" >
