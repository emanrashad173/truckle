                                    ...
                                    <div class="form-horizontal" role="form">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" name="ar_name" class="form-control" placeholder="أكتب أسم  القسم  باللغة العربية" value="{{old('ar_name')}}" required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" name="en_name" class="form-control" placeholder="أكتب أسم  القسم  باللغة الانجليزية" value="{{old('en_name')}}" required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" name="hi_name" class="form-control" placeholder="أكتب أسم  القسم  باللغة الهندية" value="{{old('hi_name')}}" required>
