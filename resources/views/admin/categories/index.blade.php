                        ...
                        @foreach($categories as $category)
                            @if($category->parent_id == null)
                                <tr class="odd gradeX">
                                    ...
                                    <td><?php echo ++$i ?></td>
                                    <td>
                                      <img src="{{asset('/uploads/categories/'.$category->photo)}}" width="100" height="100">
                                    </td>
                                    <td> {{$category->ar_name}} </td>
                                    <td> {{$category->en_name}} </td>
                                    <td> {{$category->hi_name}} </td>
                                    @php 
                                      $orders = App\Order::where('category_id',$category->id)->where('state','completed')->count();
                                    @endphp
                                    <td> {{$orders}} </td>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-left" role="menu">
                                                ...
                                                <li>
                                                    <a class="delete_country" data="{{$category->id}}" data_name="{{$category->ar_name}}" >
