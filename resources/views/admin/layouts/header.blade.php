<div class="page-header navbar navbar-fixed-top">
    ...
    <div class="page-header-inner ">
        ...
        <div class="page-logo">
            <a href="">
            @php 
                 $image = App\Setting::find(1)->image;
            @endphp
            <img src="{{asset('/uploads/logo/'.$image)}}" alt="logo" style="width: 104px; height:30px;" class="logo-default"></a>
        ...
        <div class="top-menu">
            <ul class="nav navbar-nav pull-right">
                ...
                <li class="dropdown dropdown-user">
                    <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                        <img src="{{asset('/uploads/logo/'.$image)}}"class="img-circle" alt="">
                    ...
                    <ul class="dropdown-menu dropdown-menu-default">
                        ...
                        <li>
                            <a href="/admin/change-logo">
                                <i class="icon-settings"></i> تغيير شعار الموقع </a>
                        </li>
                        {{--<li>--}}
